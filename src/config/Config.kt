...
object Config : EnvironmentConfig("") {
    /**
     * The URL of the Space instance to report updates to.
     */
    val SPACE_URL by getEnv()

    /**
     * The Space client id.
     */
    val SPACE_CLIENT_ID by getEnv()

    /**
     * The Space client secret.
     */
    val SPACE_CLIENT_SECRET by getEnv()

    /**
     * The Space channel id to report updates to.
     */
    val SPACE_CHANNEL_ID by getEnv()

    /**
     * The Crisp webhook client secret.
     */
    val CRISP_SECRET by getEnv()
}
